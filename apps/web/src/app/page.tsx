                        ...
                        <div className="order-1 lg:order-2 flex justify-center lg:justify-end">
                          ...
                          >
                            <Image
                              ...
                              width={300}
                              height={300}
                              className="object-contain w-full h-full transition-all duration-700 scale-110"
                              style={{
                    ...
                    {[
                      {
                        ...
                        image: '/banners/capa1.png'
                      },
                      {
                        category: 'Proteja seu Capital',
                        title: 'Preserve valor contra a inflação monetária.',
                        image: '/banners/capa2.png'
                      },
                      {
                        category: 'Liberdade',
                        title: 'Acesse mercados globais sem limitações.',
                        image: '/banners/capa3.png'
                      },
                      {
                        category: 'Segurança',
                        title: 'Proteção total dos seus dados e dinheiro.',
                        image: '/banners/capa4.png'
                      },
                      {
                        category: 'Integrações',
                        title: 'Conecte com as ferramentas que você usa.',
                        image: '/banners/capa5.png'
                      },
                      {
                        category: 'Moedas Digitais',
                        title: 'Acesso fácil ao mercado cripto.',
                        image: '/banners/capa6.png'
                      }
                    ].map((benefit, index) => (
                      <div key={index} className="last:pr-[5%] md:last:pr-[33%]">
                        <button className="relative z-10 flex h-80 hover:scale-102 rounded-xl transition-transform ease-linear w-56 flex-col items-start justify-end overflow-hidden md:rounded-3xl bg-gray-100 md:h-160 md:w-96">
                          <div className="absolute inset-0 bg-gradient-to-b from-white/30 via-white/20 to-black/40 hover:from-transparent hover:via-transparent hover:to-black/40 transition-all duration-300 z-30"></div>
                          ...
                          <Image
                            className={`h-full w-full transition duration-300 absolute inset-0 z-10 object-cover ${
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center space-x-3 mb-4 md:mb-0">
              <Image
                ...
                width={96}
                height={96}
                className="rounded-lg filter grayscale brightness-50"
              />
            </div>
