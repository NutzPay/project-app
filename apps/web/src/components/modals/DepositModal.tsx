...
export default function DepositModal({ isOpen, onClose }: DepositModalProps) {
  ...
  // Polling para verificar status do pagamento (temporário - substituindo WebSocket)
  useEffect(() => {
    ...
    const pollInterval = setInterval(async () => {
      try {
        ...
        if (data.success && data.transaction.status === 'COMPLETED') {
          ...
          // Show confirmation and move to success
          setTimeout(() => {
            ...
            setPaymentStatus({
              ...
              status: 'confirmed',
              usdtAmount: data.transaction.amount,
              brlAmount: data.transaction.brlAmount,
  ...
  // Valores mock para compatibilidade
              ...
              {form.method === 'usdt' && (
                <div className="mt-2 space-y-2">
                  <p className="text-xs text-gray-600">
                    Valor mínimo: $1.00 USD • Taxa de conversão aplicada na confirmação
                  </p>
                  ...
                  <>
                    <div className="text-center">
                      {usdtData.usdtAmount && (
                        <p className="text-sm font-medium text-gray-800 mb-2">
                          Você receberá: <span className="font-bold">{usdtData.usdtAmount} USDT</span>
                          {usdtData.exchangeRate && (
                            <span className="text-gray-600 ml-2">(Taxa: R$ {usdtData.exchangeRate}/USD)</span>
                          )}
                        </p>
                      )}
                    </div>
                    ...
                    <div className={`relative bg-white border-2 border-gray-200 rounded-xl p-3 text-center ${
                      ...
                      {paymentProcessingStep !== 'waiting' && (
                        <div className="absolute inset-0 bg-black bg-opacity-75 rounded-xl flex items-center justify-center z-10">
                          <div className="text-center text-white">
                            {paymentProcessingStep === 'detected' && (
                              <div className="animate-bounce">
                                ...
                                <p className="font-bold text-lg">💰 Pagamento Detectado!</p>
                                <p className="text-sm opacity-90">Processando...</p>
                              </div>
                            )}
                            ...
                            {paymentProcessingStep === 'processing' && (
                              <div className="animate-pulse">
                                ...
                                <p className="text-sm opacity-90">Aguarde um momento...</p>
                              </div>
                            )}
                            ...
                            {paymentProcessingStep === 'confirmed' && (
                              <div className="animate-bounce">
                                ...
                                <p className="font-bold text-lg">✅ Confirmado!</p>
