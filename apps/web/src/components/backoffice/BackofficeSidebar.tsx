...
export default function BackofficeSidebar({ sidebarOpen, setSidebarOpen }: BackofficeSidebarProps) {
      ...
      {sidebarOpen && (
        <div className="fixed inset-0 z-40 flex lg:hidden">
          ...
          <div className="relative flex w-full max-w-xs flex-1 flex-col bg-white border-r border-gray-200">
            ...
            <BackofficeSidebarContent pathname={pathname} />
          </div>
        </div>
      )}
...
function BackofficeSidebarContent({ pathname }: { pathname: string }) {
  return (
    <div className="flex flex-1 flex-col overflow-y-auto">
      {/* Logo and Brand */}
      <div className="flex items-center flex-shrink-0 px-6 py-6 border-b border-gray-200">
        <Link href="/backoffice" className="flex items-center group">
