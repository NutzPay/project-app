...
export default [
  ...
  {
    path: '/docs/docs',
    component: ComponentCreator('/docs/docs', '7e8'),
    routes: [
      {
        path: '/docs/docs',
        component: ComponentCreator('/docs/docs', 'f40'),
        routes: [
          {
            path: '/docs/docs',
            component: ComponentCreator('/docs/docs', '22a'),
            routes: [
              {
                path: '/docs/docs/getting-started',
                component: ComponentCreator('/docs/docs/getting-started', 'ab5'),
                exact: true
              },
              {
                path: '/docs/docs/intro',
                component: ComponentCreator('/docs/docs/intro', '743'),
                exact: true,
